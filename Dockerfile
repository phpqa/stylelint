...
ARG NPM_NAME="stylelint"
ARG PHPQA_NAME="stylelint"
ARG VERSION="9.3.0"
...
RUN npm install --global stylelint && npm cache clear --force

# Install stylelint config standard - https://github.com/stylelint/stylelint-config-standard

RUN npm install --save-dev stylelint-config-standard && npm cache clear --force
